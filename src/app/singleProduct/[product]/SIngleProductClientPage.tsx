...
interface ISingleProductPageClient{
    productResponse:APIResponseSuccess<IProductDisplay>
}
const SingleProductPageClient:React.FC<ISingleProductPageClient> = ({productResponse}) => {
  ...
  const productDatas = isProductPending ? productResponse.data : productDetails.data
  useEffect(() => {
    if (productDatas) {
