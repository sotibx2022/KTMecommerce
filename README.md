...
5. select list for state/provience/suggestions from city.- 1 day
10. recently viewed products to debug cart and wishlist listing issues.- 1 day
3. landing page loading animation, category page - 1 day
ADMIN SIDE
